...
<body onload="getMessage()" style="background-color: #2c3338;">
									...
									<table width="100%">
										<tr>
											...
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<input name="authorCode" id="authorCode" type="text" readonly="readonly" value="<c:out value='${authorManage.authorCode}'/>" size="40"/>
										...
										<tr>
											<td id="captionTitle" align="center"><spring:message code="smart.manage.auth.item.regdate" /></td>
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<input name="authorCreatDe" id="authorCreatDe" type="text" value="<c:out value='${authorManage.authorCreatDe}'/>" maxLength="50" size="20" readonly="readonly"/>
											</td>
										</tr>
									</table>
								</div>
