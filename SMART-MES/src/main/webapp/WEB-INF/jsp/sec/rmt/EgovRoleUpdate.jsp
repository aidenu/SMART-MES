						...
						<tr>
							<td width="*">
								<div style="width:1000px;border: 1px solid #D5D1B0;">
									<table width="100%">
										<tr>
											<td id="captionTitle" align="center"><spring:message code="space.manage.role.item.rolecode" /></td>
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<input name="roleCode" id="roleCode" type="text" value="<c:out value='${roleManage.roleCode}'/>" size="50" readonly="readonly"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td id="captionTitle" align="center"><spring:message code="space.manage.role.item.roleregdate" /></td>
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<input name="roleCreatDe" id="roleCreatDe" type="text" value="<c:out value='${roleManage.roleCreatDe}'/>" maxLength="50" size="50" readonly="readonly"/>
											</td>
										</tr>
									</table>
								</div>
