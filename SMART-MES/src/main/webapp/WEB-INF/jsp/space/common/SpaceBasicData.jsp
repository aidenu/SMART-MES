...
<script>
	...
	function getBasicData(level)
	{
		...
		document.dataForm.action="${pageContext.request.contextPath}/space/common/SpaceBasicDataList.do";
	...
	function setBasicData(level,gubun)
	{
		...
		document.dataForm.action="${pageContext.request.contextPath}/space/common/SpaceBasicDataAction.do";
		document.dataForm.target = "hiddenFrame";
		document.dataForm.submit();
	}
