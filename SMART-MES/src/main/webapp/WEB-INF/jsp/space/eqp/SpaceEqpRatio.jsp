...
<script>
	...
	//좌측 MODEL LIST 항목 셋팅
	jq$(function(){
		div_height = document.body.clientHeight-200;
		div_width = document.body.clientWidth-400;
		document.getElementById("myChart").height = div_height;
		document.getElementById("myChart").width = div_width;
	...
	function getData(){
		...
		document.searchForm.action="${pageContext.request.contextPath}/space/eqp/SpaceEqpRatioData.do";
	...
	function getExcel()
	{
		...
		document.searchForm.action="${pageContext.request.contextPath}/space/eqp/SpaceEqpRatioExcel.do";
		document.searchForm.target = "searchFrame";
		document.searchForm.submit();
	}
</script>
			...
			<tr>
				<td valign="top">
					<table>
						<tr>
							<td width="*" colspan="2">
								<div style="width:630px;border: 1px solid #D5D1B0;">
						...
						<tr>
							...
							<td style="vertical-align: top;">
								<br><br>
								<div id="allStatus" style="display: inline-block;vertical-align: top;"></div>
								<div id="machineStatus" style="display: inline-block;vertical-align: top;"></div>
							</td>
						</tr>
					</table>
				</td>
