...
<script>
	...
	strTitleHtml.append("			<tr>");
	strTitleHtml.append("				<td nowrap height='91' class='TIT_CONT_GRAY_C' style='width:20%;'>대분류</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:20%;'>소분류</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:12%;'>파이(mm)</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:12%;'>F/B</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:12%;'>R(mm)</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:12%;'>기장(mm)</td>");
	strTitleHtml.append("				<td nowrap class='TIT_CONT_GRAY_C' style='width:12%;'>이월재고</td>");
	strTitleHtml.append("			</tr>");
	...
	<c:forEach var="result" items="${result}" varStatus="status">
		strTitleHtml.append("			<tr title='${result.TOOL_ID}'>");
		strTitleHtml.append("				<td height='40' class='BG_WHITE_C' nowrap style='width:20%;'>${result.MAIN_CATEGORY}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:20%;'>${result.SUB_CATEGORY}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:12%;'>${result.TOOL_PIE}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:12%;'>${result.TOOL_FB}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:12%;'>${result.TOOL_R}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:12%;'>${result.TOOL_LENGTH}</td>");
		strTitleHtml.append("				<td class='BG_WHITE_C' style='width:12%;'>${result.REMAIN_COUNT}</td>");
		strTitleHtml.append("			</tr>");
	</c:forEach>
	strTitleHtml.append("			</table>");
