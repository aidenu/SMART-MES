...
<title><spring:message code="smart.stock.tool.hist.title" /></title>
	...
	$(document).ready(function() {
		...
		*/
		$("#btn_search").click(function() {
			...
			document.dataForm.action="${pageContext.request.contextPath}/smart/stock/SmartToolHistData.do";
							...
							<div class="row align-items-center justify-content-between">
								<div class="col-auto mt-4">
									<h1 class="page-header-title">
										...
										<span><spring:message code="smart.stock.tool.hist.title" /></span>
									</h1>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid" id="dataContainer">
					...
					<form name="dataForm" method="post">
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								<div class="datatable table-responsive" style="float: left;width:40%;">
									<table id="data_table_head" cellpadding="0" cellspacing="0" border="0" style="width:100%;"> 
										
									</table>
								</div>
								<div class="datatable table-responsive" style="overflow-x: scroll;width:60%;">
