...
<title><spring:message code="smart.assembly.title" /></title>
...
<script>
	...
	$(document).ready(function() {
		...
		*/
		$("#btn_search").click(function() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/smart/assembly/SmartAssemblyModelData.do",
	...
	*/
	$(document).on("click", "div[id$='_detail']", function(){
		...
		window.open("<c:url value='/smart/assembly/SmartAssemblyData.do?modelid="+modelid+"'/>", "partListPop", "scrollbars=yes,toolbar=no,resizable=yes,left=200,top=200,width=1200,height=850");
							...
							<div class="row align-items-center justify-content-between">
								<div class="col-auto mt-4">
									<h1 class="page-header-title">
										...
										<span><spring:message code="smart.assembly.title" /></span>
									</h1>
								</div>
							</div>
						</div>
