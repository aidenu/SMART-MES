...
<c:forEach var="result" items="${result}" varStatus="status">
	...
	headerHtml.append("				<div class='wizard-step-text-name'>${result.EQP_NAME_VIEW}</div>");
	headerHtml.append("				<div class='wizard-step-text-details'>${result.EQP_PROGRAM}</div>");
...
<c:forEach var="result" items="${result}" varStatus="status">
	...
	bodyHtml.append("	            <h3 class='text-primary'>Step 1</h3>");
	bodyHtml.append("	            <h5 class='card-title'>${result.EQP_NAME_VIEW}</h5>");
