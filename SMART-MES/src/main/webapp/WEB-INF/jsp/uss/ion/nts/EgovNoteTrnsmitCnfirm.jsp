...
<c:set var="ImgUrl" value="/images/egovframework/uss/ion/ntr/"/>
<c:set var="CssUrl" value="/css/egovframework/uss/ion/ntr/"/>
...
padding-top : 3px;
padding-left : 50px;
background-image : url('/images/egovframework/cmm/uss/umt/left_menu_bg.gif');
}
.LeftMenuBtn {
text-align : center;
padding-top : 5px;
...
padding-top : 3px;
padding-left : 60px;
background-image : url('/images/egovframework/cmm/uss/umt/left_bg.gif');
}
.QuickLink {
font-size : 11px;
color : #7794be;
...
font-weight : bold;
padding-left : 45px;
background-image : url('/images/egovframework/cmm/uss/umt/page_title.gif');
}
.PageNumber {
text-align : center;
font-family : "돋움";
...
font-weight : bold;
color : #4f657d;
background : url('/images/egovframework/cmm/uss/umt/bg_list_th.gif');
}
.table_listA tbody {
height : 35px;
font : 11px Dotum;
...
top : 3px;
background-color : transparent;
background-image : url(/images/egovframework/cmm/uss/umt/icon/icon_prevend.gif);
border-style : none;
}
.page_prev {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url(/images/egovframework/cmm/uss/umt/icon/icon_prev.gif);
border-style : none;
}
.page_nextend {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url(/images/egovframework/cmm/uss/umt/icon/icon_nextend.gif);
border-style : none;
}
.page_next {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url(/images/egovframework/cmm/uss/umt/icon/icon_next.gif);
border-style : none;
}
.page_no {
width : 30px;
...
.btnBackground {
background-image : url(/images/egovframework/cmm/uss/umt/button/bu2_bg.gif);
}
...
<center>
	...
	<tr> 
	     <td><img src="${ImgUrl}button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	     <td class="btnBackground"><a href="#LINK" onClick="fn_egov_close_TrnsmitCnfirm()">닫기</a></td>
	     <td><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
	     <th scope="col">&nbsp;</th>      
	</tr>
	</table>
</center>
