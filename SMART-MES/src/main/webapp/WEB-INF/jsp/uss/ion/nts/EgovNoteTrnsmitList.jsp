...
<c:set var="ImgUrl" value="/images/egovframework/uss/ion/nts/"/>
<c:set var="CssUrl" value="/css/egovframework/uss/ion/nts/"/>
...
<tr>
	...
	<label for="searchCondition"> </label>
   	<select name="searchCondition" class="select" style="width:100%" title="검색조건">
