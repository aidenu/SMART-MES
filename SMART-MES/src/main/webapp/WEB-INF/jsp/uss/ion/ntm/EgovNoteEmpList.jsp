 ...
 <tr>
  ...
  <td scope="col" width="30px" align="center">
	...
	<tr> 
	  ...
	  <td style="padding:0 0 0 0;"><img src="${ImgUrl}button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>      
	</tr>
	</table>
  </td>  
 </tr>
...
<tr>
    	...
    	<!--  <a href="#" onClick="JavaScript:fn_egov_open_Popup('${status.count}', '${resultInfo.uniqId}')">선택  -->
</tr>   
</c:forEach>
</tbody>  
</table>
