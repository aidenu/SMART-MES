...
<c:set var="ImgUrl" value="/images/egovframework/uss/ion/ntm/"/>
<c:set var="CssUrl" value="/css/egovframework/uss/ion/ntm/"/>
<%--  자마스크립트 메세지 출력 --%>
${reusltScript}
...
<tr> 
   ...
   <!--  수신자  목록/찾기 영역  -->
	<div style="float:left;padding:0px 10px 0px 0px;border:solid 0px #000000;">
		...
		<tr>
			...
			<tr> 
			     <th scope="col" style="padding:0 0 0 0;"><img src="${ImgUrl}button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></th>
			     <td class="btnBackground"><a href="#LINK" onClick="fn_egov_delete_NoteManage(1);">삭제</a></td>
			     <td style="padding:0 0 0 0;"><img src="<c:out value="${ImgUrl}"/>button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
			     <td style="padding:0 0 0 0;background-color:#f7f7f7;">&nbsp;</td>
			     
			     <td style="padding:0 0 0 0;"><img src="${ImgUrl}button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>
   ...
   <div style="float:left;height:20px;padding:80px 10px 0px 0px;border:solid 0px #000000;">
	<form:radiobutton path="recptnSe" value="01"/>수신
	<form:radiobutton path="recptnSe" value="02"/>참조
	<form:errors path="recptnSe" cssClass="error"/>
   </div>
   <div style="float:left;height:20px;padding:80px 10px 0px 0px;border:solid 0px #000000;">
	<a href="/uss/ion/ntm/listEgovNoteEmpListPopup.do" target="_blank" title="수신자/참조자 선택  팝업 새창으로" onclick="fn_egov_popupOpen_PopupManage('<c:url value='/'/>/uss/ion/ntm/listEgovNoteEmpListPopup.do','empPopup',760,400);return false"><img src="<c:url value='${ImgUrl}button/search2.gif'/>" alt="수신자찾기버튼" title="수신자찾기버튼"></a>
   </div>
...
<tr> 
  <th scope="col"><img src="${ImgUrl}button/bu2_left.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></th>
  ...
  <td><img src="${ImgUrl}button/bu2_right.gif" alt="버튼이미지" title="버튼이미지" width="8" height="20"></td>      
</tr>
</table>
</center>
</form:form>
