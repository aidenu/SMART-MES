    ...
    <div id="container">
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <!-- 검색 필드 박스 시작 -->
                <div id="search_field">
                    <div id="search_field_loc"><h2><strong>게시판정보</strong></h2></div>
                    <form name="frm" action="<c:url value='/cop/bbs/SelectBBSMasterInfs.do'/>" method="post">
                        ...
                        <div class="sf_start">
                            ...
                            <ul id="search_second_ul">
                                <li>
                                    <div class="buttons" style="position:absolute;left:870px;top:175px;">
                                        <a href="<c:url value='/cop/bbs/SelectBBSMasterInfs.do'/>" onclick="JavaScript:fn_egov_select_brdMstr('1'); return false;" onclick="fn_egov_select_brdMstr('1'); return false;"><img src="<c:url value='/images/img_search.gif' />" alt="search" />조회 </a>
