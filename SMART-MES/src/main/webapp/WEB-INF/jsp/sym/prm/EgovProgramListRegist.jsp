...
<div id="wrap">
								...
								<div style="width:1000px;border: 1px solid #D5D1B0;">
									<table width="100%">
										...
										<tr>
											...
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<form:input path="progrmStrePath"  size="50"   maxlength="60"/> 
										...
										<tr>
											...
											<td id="captionSubTitle" align="left" style="padding-left:10px">
												<form:textarea path="progrmDc" rows="5" cols="50" cssClass="txaClass"/>
	...
	<div style="width:1000px" align="center">
		<table>
			<tr>
				<td>
					<a class='AXButton Gray' href="<c:url value='/sym/prm/EgovProgramListManageSelect.do'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a> 
					<a class='AXButton Gray' href="#LINK" onclick="javascript:insertProgramListManage(document.getElementById('progrmManageVO')); return false;"><spring:message code="button.save" /></a>
				</td>
			</tr>
		</table>
    </div>
