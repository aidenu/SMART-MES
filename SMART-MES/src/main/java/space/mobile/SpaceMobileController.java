...
@Controller
public class SpaceMobileController {
...
Logger logger = Logger.getLogger("egovframework");
	...
	public String getSpaceMobileLoginCheckPage(
		...
		if(loginVO.getId() != null) 
		{
	        ...
	        if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) 
	        {
				...
				List<HashMap> resultRole = spaceCommonDAO.nosessioncommonDataProc("getMobileUserRole",hp);
	...
	public String getSpaceMobileAppkeyRegistPage(
		...
		try{
			...
			if(userid != null && !"".equals(userid))
			{
				...
				List<HashMap> result = spaceCommonDAO.nosessioncommonDataProc("setMobileAppkeyRegist",hp);
	...
	public String getSpaceMobileAppkeyDeletePage(
			@RequestParam(value="userid", required=false) String userid,
			@RequestParam(value="appkey", required=false) String appkey,
            ModelMap model
			) throws Exception {
		...
		try{
			...
			if(userid != null && !"".equals(userid))
			{
				...
				List<HashMap> result = spaceCommonDAO.nosessioncommonDataProc("setMobileAppkeyDelete",hp);
    ...
    public String getSpaceMobileAlarmListPage(
    		@RequestParam(value="userid", required=false) String userid,
    		ModelMap model
    		)throws Exception {
		...
		try{
			...
			List<HashMap> result = spaceCommonDAO.nosessioncommonDataProc("getMobileAlarmList",hp);
    ...
    public String getSpaceMobileAlarmHiddenListPage(
    		@RequestParam(value="userid", required=false) String userid,
    ...
    public String getSpaceMobileAlarmCongirmPage(
    		@RequestParam(value="userid", required=false) String userid,
		...
		try{
			...
			List<HashMap> result = spaceCommonDAO.nosessioncommonDataProc("setMobileAlarmData",hp);
	...
	public String model_eqp_status(
		...
		try{
			...
			List<HashMap> result = spaceCommonDAO.nosessioncommonDataProc("getEqpStatus");
			model.addAttribute("result", result);
