...
public class EgovAuthorRoleController {
	...
	public String insertAuthorRole(@RequestParam(value="authorCode",required=false) String authorCode,
		...
		if(authorCode != null && authorCode != "")
		{
	    	...
	    	//권한관리에서 수정한 내용을 실시간 반영하기 위해서 호출
