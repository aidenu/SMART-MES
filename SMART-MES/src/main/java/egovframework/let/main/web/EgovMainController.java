...
public class EgovMainController {
	...
	Logger logger = Logger.getLogger(EgovMainController.class);
     ...
     * @exception Exception
     */
    @RequestMapping(value="/sym/mms/EgovMainMenuSub.do")
    public String selectMainMenuSub(
    		ModelMap model)
            throws Exception {
    	...
    	if(EgovUserDetailsHelper.isAuthenticated()){
      	...
      	return "main/inc/EgovIncSubmenu";
    }
